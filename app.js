...
async function registrarUsuario() {
  ...
  try {
    const response = await fetch('https://-backend-url.com/api/usuarios/registro', {
      method: 'POST',
...
async function iniciarSesion() {
  ...
  try {
    const response = await fetch('https://-backend-url.com/api/usuarios/login', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function obtenerProductos() {
  try {
    const response = await fetch('https://-backend-url.com/api/productos');
...
async function guardarLista() {
  ...
  try {
    const response = await fetch('https://-backend-url.com/api/listas', {
      method: 'POST',
      headers: { 
    ...
    if (response.ok) {
      ...
      for (const item of listaActual) {
        ...
        if (producto) {
          await fetch('https://-backend-url.com/api/items', {
            method: 'POST',
            headers: { 
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${token}`
...
async function cargarLista(idLista) {
  try {
    const response = await fetch(`https://-backend-url.com/api/items/${idLista}`, {
      headers: { 'Authorization': `Bearer ${token}` }
    });
